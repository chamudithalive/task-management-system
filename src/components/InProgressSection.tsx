...
const InProgressSection: FunctionComponent = () => {
  return (
      <div className="absolute top-[6.5rem] left-[42rem] rounded-xl bg-generic-white-bg border-dark-100 border-[1px] border-dashed box-border w-[22.75rem] h-[56.25rem] overflow-hidden">
